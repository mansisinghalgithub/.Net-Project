...
namespace EnterpriseHub_1.Controllers
{
    ...
    public class DepartmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DeptNo,DeptName,DeptHead")] Department department)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DeptNo,DeptName,DeptHead")] Department department)
        {
